-- Library
-- Coded by _notportal
-- First used by supercoolboi34 (not starhook gave it to linemaster for our project which was called Starhook)
--[[
...
do
	...
	do
		...
		function Library:New(Properties)
			...
			Logo.Name = "Logo"
			Logo.Image = "http://www.roblox.com/asset/?id=17657619514"
		...
		function Library:Watermark(Properties)
			local Watermark = {
				Name = (Properties.Name or Properties.name or "sharp.cc | placeholder");
				AnimateText = nil;
			}
			--
			local Outline = Instance.new("Frame")
			...
			CC.Name = "Title"
			CC.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json")
			CC.RichText = true
			CC.Text = "cc"
			CC.TextColor3 = Library.Accent
			CC.TextSize = 13
			...
			CC.Position = UDim2.fromOffset(24, 0)
			CC.Size = UDim2.fromScale(0, 1)
			CC.Parent = Inline
			CC.ZIndex = 2
			...
			task.spawn(function()
				while wait() do 
					for i = 1, #"Sharp.cc" do
						Watermark.AnimateText = string.sub("Sharp.cc", 1, i) .. "";
						CC.Text = string.sub("      cc", 1, i) .. ""
